const Loader = () => {
    return (
        <main className="bg-[#373839] min-h-screen font-lato flex justify-center items-center">
            <div className="flex flex-col justify-center items-center gap-3">
                <img src="/image/loader/img01.png" alt="Weather icon" />
                ...
                <h2 className="text-white font-bold text-xl animate-bounce">Cargando</h2>
            </div>
        </main >
